...
public class MovieScheduleConflictTest {
    ...
    public void testScheduleConflictValidation() {
        // Create first schedule: Movie 1 from 10:00 to 12:00 (assuming 120 min
        // duration)
        ...
        // Create conflicting schedule: Movie 2 from 11:00 to 13:00 (same room,
        // overlapping time)
        ...
        try {
            ...
            ScreeningScheduleDto savedSchedule1 = movieScheduleService
                    .saveOrUpdateScreeningScheduleWithValidation(schedule1);

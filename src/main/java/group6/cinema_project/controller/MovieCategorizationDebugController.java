 ...
 * This controller provides endpoints to help diagnose and fix categorization
 * issues.
 */
@Controller
...
public class MovieCategorizationDebugController {
    ...
    public Map<String, Object> testCategorization() {
        ...
        try {
            ...
            // Check consistency
            boolean consistent = testResults.get("currentlyPlaying").equals(testResults.get("activeStatus")) &&
